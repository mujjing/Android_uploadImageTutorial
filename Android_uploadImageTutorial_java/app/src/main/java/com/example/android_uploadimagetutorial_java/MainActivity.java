...
import com.example.android_uploadimagetutorial_java.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void addCustomer(String name, String refrence) {
        ...
        RequestBody cus_reference = RequestBody.create(MediaType.parse("multipart/form-data"), refrence);

        ApiService apiService = retrofit.create(ApiService.class);
        Call<AddCustomerRes> call = apiService.addCutomer(body, cus_name, cus_reference);
